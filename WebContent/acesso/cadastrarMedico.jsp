...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Cadastrar Médico</h1>
					</div>
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<form action="/CentroMedico/UsuarioServlet?act=put"
										method="post">
										<input type="hidden" name="tipoUsuario" value="medico">
										<input type="hidden" name="idMedico" value="<%=new ControlerMedico().recuperaId()%>">
										<div class="row">
											...
											<div class="col-md-2 form-group">
												<label for="cpf" style="color: black;">CRM</label> <input
													type="text" name="crm" id="crm"
													class="form-control form-control-md" required="required">
											</div>
			...
			<footer class="sticky-footer bg-white">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; Centro Médico 2019</span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
	...
	%>
	<script type="text/javascript">
		swal("Sucesso!", "Médico cadastrado com sucesso!", "success");
	</script>
	...
	%>
	<script type="text/javascript">
		swal("Erro!", "Esse Médico já está cadastrado no sistema", "error");
	</script>
